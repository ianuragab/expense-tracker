    ...
    <ImageBackground source={require('../assets/images/card.png')} style={styles.bgImage} resizeMode='stretch' >
      <View style={styles.container}>
        <View>
          ...
          <Typo size={28} fontWeight={'bold'} color={colors.black}>₹ 12,069.00</Typo>
        </View>
        {/* income */}
        <View style={styles.stats}>
          ...
          <View style={{ alignSelf: 'center' }}><Typo size={17} color={colors.green} fontWeight={600}>₹ 12,069</Typo></View>
        </View>
        {/* expense */}
        <View style={styles.stats}>
          <View style={styles.incomeExpense}>
          ...
          <View style={{ alignSelf: 'center' }}><Typo size={17} color={colors.rose} fontWeight={600}>₹ 12,069</Typo></View>
        </View>
      </View>
    </ImageBackground>
  )
